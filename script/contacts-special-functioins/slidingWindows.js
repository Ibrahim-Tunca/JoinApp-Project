/**
 * Closes the add-contact and edit-contact windows
 * and resets the related overlay and button styles.
 */
...
/**
 * Opens the add-contact window and shows the overlay.
 */
...
/**
 * Opens the edit-contact window, fills in the current contact values,
 * and shows the overlay.
 *
 * @param {string} name - The current contact name.
 * @param {string} mail - The current contact email address.
 * @param {string} initials - The initials shown for the contact avatar.
 * @param {string} color - The color class of the contact avatar.
 * @param {string} phone - The current contact phone number.
...
/**
 * Shows the success popup after a contact has been created.
 */
...
/**
 * Shows the success popup after a contact has been deleted.
 */
